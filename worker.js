class RiseLooterHead {
  element(element) {
    element.append('<link rel="stylesheet" href="/creator-hd.css?v=8">', { html: true });
...
export default {
  async fetch(request, env) {
    ...
    headers.set('x-riselooter-creator-source', 'modular-canonical-fullbody');
    headers.set('x-riselooter-creator-version', 'fullbody-v14');
