class RiseLooterHead {
  element(element) {
    ...
    element.append('<script src="/safe-ui-bootstrap.js?v=layered-v3" defer></script>', { html: true });
  }
}
...
export default {
  async fetch(request, env) {
    ...
    headers.set('x-riselooter-creator-source', 'layered-v3');
    headers.set('x-riselooter-creator-version', 'layered-v3');
    headers.set('x-riselooter-runtime-hotfixes', 'safe-bootstrap-layered-v3');
