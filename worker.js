class RiseLooterHead {
  element(element) {
    ...
    element.append('<script src="/site-polish-v3.js?v=3" defer></script>', { html: true });
  }
}
...
export default {
  async fetch(request, env) {
    ...
    headers.set('x-riselooter-creator-version', 'fixed-gender-v1-stage-home-v2-polish-v3-right-position');
    headers.set('x-riselooter-runtime-hotfixes', 'safe-bootstrap-fixed-gender-v1-stage-home-v2-polish-v3-right-position');
