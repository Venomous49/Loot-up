...
export default {
  async fetch(request, env) {
    ...
    headers.set('x-riselooter-creator-version', 'fixed-gender-v1-stage-home-v2');
    headers.set('x-riselooter-runtime-hotfixes', 'safe-bootstrap-fixed-gender-v1-stage-home-v2');
