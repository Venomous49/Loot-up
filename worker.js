class RiseLooterHead {
  element(element) {
    ...
    element.append('<script src="/fixed-stage-home.js?v=6" defer></script>', { html: true });
    element.append('<script src="/site-polish-v3.js?v=6" defer></script>', { html: true });
  }
}
...
export default {
  async fetch(request, env) {
    ...
    headers.set('x-riselooter-creator-version', 'fixed-gender-v1-stage-home-v6-pristine-safe');
    headers.set('x-riselooter-runtime-hotfixes', 'safe-bootstrap-fixed-gender-v1-stage-home-v6-pristine-safe');
