class RiseLooterHead {
  element(element) {
    ...
    element.append('<script src="/safe-ui-bootstrap.js?v=superres-x4-v1" defer></script>', { html: true });
    element.append('<script src="/fixed-stage-home.js?v=superres-x4-v1" defer></script>', { html: true });
...
export default {
  async fetch(request, env) {
    ...
    headers.set('x-riselooter-creator-version', 'superres-x4-v1');
    headers.set('x-riselooter-runtime-hotfixes', 'superres-x4-v1');
